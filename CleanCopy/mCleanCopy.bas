...
#If Mac Then
 fromC = ChrW(160) & "ÐÓÒÕÔ¥‹Žˆ‡‰Œ‘“’”•˜—™›¿œž"
 s = Replace(Replace(Replace(Replace(Replace(s, "É", "..."), "Ñ", "--"), "Š", "ae"), "š", "oe"), "Ÿ", "ue") ' mulitcharacter replaces ÑŠšŸ
#Else
 fromC = ChrW(160) & "–”“’‘•ãèéàáâåçêëìíîïòóôõøùúû"
 s = Replace(Replace(Replace(Replace(Replace(s, "…", "..."), "—", "--"), "ä", "ae"), "ö", "oe"), "ü", "ue") ' mulitcharacter replaces ÑŠšŸ
#End If
