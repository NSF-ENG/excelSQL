...
'         .Item(.count).SetLastPriority
    ...
    With ckAwd.Range("ckAwdQTable[[rqst_eff_date]:[Country]]").FormatConditions
        ...
        .Item(1).StopIfTrue = False
    End With
    With ckAwd.Range("ckAwdQTable[rqst_tot]").FormatConditions ' request < budget
        .Add Type:=xlExpression, Formula1:="=$AG2<$AI2"
        .Item(.count).SetFirstPriority
        With .Item(1).Interior
            .PatternColorIndex = xlAutomatic
            .Color = 11518971 ' pink
    ...
    With ckAwd.Range("ckAwdQTable[rqst_tot]").FormatConditions ' request > budget
        ...
        End With
         .Item(1).StopIfTrue = False
    End With
    With ckAwd.Range("ckAwdQTable[[part_tot_dol]:[part_tot_cnt]]").FormatConditions
        .Add Type:=xlExpression, Formula1:="=XOR($AT2>0,$AU2>0)"
        .Item(.count).SetFirstPriority
        With .Item(1).Interior
            .PatternColorIndex = xlAutomatic
            .Color = 11518971
    ...
    With ckAwd.Range("ckAwdQTable[[prop_titl_txt]]").FormatConditions
        .Add Type:=xlExpression, Formula1:="=$BF2"
        .Item(.count).SetFirstPriority
        With .Item(1).Interior
            .PatternColorIndex = xlAutomatic
            .Color = 14540024
